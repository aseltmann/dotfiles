...
(doom! :input
       ...
       lsp               ; (support for language servers) M-x vscode
       ...
       tree-sitter       ; (syntax highlighter) syntax and parsing, sitting in a tree...
       ...
       data                ; (support for .csv with SPC-m) config/data formats
       ...
       (ess                ; (support for R, Julia, STATA, SAS, S-Plus) emacs speaks statistics
        +tree-sitter
        +lsp)
       ;;factor
       ...
       (markdown           ; writing docs for people to ignore
        +grip)             ; (grip gives github-like preview with SPC-p)
       ...
       ;;(rust +lsp)       ; Fe2O3#+INCLUDE: "/path/to/config.org".unwrap().unwrap().unwrap().unwrap()
       ;;scala             ; java, but good
